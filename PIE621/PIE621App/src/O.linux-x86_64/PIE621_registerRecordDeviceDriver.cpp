...
/* Generated from ../O.Common/PIE621.dbd */
...
epicsShareExtern dset *pvar_dset_devPIC663;
...
static const char * const deviceSupportNames[119] = {
    "devAaiSoft",
    "devaaiStream",
    "devAaoSoft",
    "devaaoStream",
...
static const dset * const devsl[119] = {
...
epicsShareExtern drvet *pvar_drvet_drvPIC663;
...
static const char *driverSupportNames[11] = {
    "drvAsyn",
    "stream",
    "drvPIC844",
    "drvPIC630",
...
epicsShareExtern void (*pvar_func_PIC663motorRegister)(void);
...
epicsShareExtern int *pvar_int_drvPIC663debug;
...
static struct iocshVarDef vardefs[] = {
	...
	{"drvPIC663debug", iocshArgInt, (void * const)pvar_int_drvPIC663debug},
...
int PIE621_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/PIE621";
    ...
    registerDevices(pbase, 119, deviceSupportNames, devsl);
    registerDrivers(pbase, 11, driverSupportNames, drvsl);
    (*pvar_func_asSub)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"PIE621_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    PIE621_registerRecordDeviceDriver(*iocshPpdbbase);
}
