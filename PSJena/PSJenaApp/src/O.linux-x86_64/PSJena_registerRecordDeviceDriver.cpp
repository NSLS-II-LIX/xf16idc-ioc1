...
/* Generated from ../O.Common/PSJena.dbd */
...
int PSJena_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/PSJena";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"PSJena_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    PSJena_registerRecordDeviceDriver(*iocshPpdbbase);
}
