...
/* Generated from ../O.Common/bestcalc.dbd */
...
int bestcalc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/bestcalc";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"bestcalc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    bestcalc_registerRecordDeviceDriver(*iocshPpdbbase);
}
