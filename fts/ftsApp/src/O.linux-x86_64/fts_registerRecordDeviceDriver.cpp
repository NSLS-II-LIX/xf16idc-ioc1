...
/* Generated from ../O.Common/fts.dbd */
...
int fts_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/fts";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"fts_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    fts_registerRecordDeviceDriver(*iocshPpdbbase);
}
