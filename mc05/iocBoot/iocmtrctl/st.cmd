...
epicsEnvSet("LOCATION", "XF:16{RG:A1}")
epicsEnvSet("STREAM_PROTOCOL_PATH", "/usr/share/epics-pmacutil-dev/protocol:${TOP}/proto")
...
pmacAsynIPConfigure("P0","xf16idb-mc5.nsls2.bnl.local:1025")
...
dbLoadRecords("db/asynComm.db","P=XF:16IDB-CT{MC:05},PORT=P0,ADDR=0")
dbLoadTemplate("db/motorstatus.substitutions")
dbLoadRecords("db/pmacStatus.db","SYS=XF:16IDB-CT,PMAC=MC:05,VERSION=1,PLC=5,PORT=P0,NAXES=8")
...
dbLoadRecords("db/iocAdminSoft.db","IOC=XF:16IDB-CT{IOC:MC05}")
dbLoadTemplate("db/encRead.substitutions")
...
dbl > "/cf-update/xf16idc-ioc1.mc5.dbl"
