...
epicsEnvSet("LOCATION", "XF:16{RG:B1}")
...
pmacAsynIPConfigure("P0","xf16idb-mc6.nsls2.bnl.local:1025")
...
# Disable limits checking for motor #4
pmacDisableLimitsCheck("M0", 4, 0)
...
dbLoadRecords("db/asynComm.db","P=XF:16IDC-CT{MC:06},PORT=P0,ADDR=0")
dbLoadTemplate("db/motorstatus.substitutions")
dbLoadRecords("db/pmacStatus.db","SYS=XF:16IDC-CT,PMAC=MC:06,VERSION=1,PLC=5,PORT=P0,NAXES=8")
...
dbLoadRecords("db/iocAdminSoft.db","IOC=XF:16IDC-CT{IOC:MC06}")
...
dbl > "/cf-update/xf16idc-ioc1.mc6.dbl"
