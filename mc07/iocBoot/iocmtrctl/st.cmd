...
pmacAsynIPConfigure("P0","xf16idb-mc7.nsls2.bnl.local:1025")
...
dbLoadRecords("db/asynComm.db","P=XF:16IDB-CT{MC:07},PORT=P0,ADDR=0")
dbLoadTemplate("db/motorstatus.substitutions")
dbLoadRecords("db/pmacStatus.db","SYS=XF:16IDB-CT,PMAC=MC:07,VERSION=1,PLC=5,PORT=P0,NAXES=8")
...
dbLoadRecords("db/iocAdminSoft.db","IOC=XF:16IDB-CT{IOC:MC07}")
