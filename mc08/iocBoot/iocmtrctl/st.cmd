...
dbLoadRecords("db/asynComm.db","P=XF:16IDC-CT{MC:08},PORT=P0,ADDR=0")
dbLoadTemplate("db/motorstatus.substitutions")
dbLoadRecords("db/pmacStatus.db","SYS=XF:16IDC-CT,PMAC=MC:08,VERSION=1,PLC=5,PORT=P0,NAXES=8")
...
dbLoadRecords("db/iocAdminSoft.db","IOC=XF:16IDC-CT{IOC:MC08}")
...
dbl > "/cf-update/xf16idc-ioc1.mc8.dbl"
