...
pmacAsynIPConfigure("P0","xf16idc-mc9.nsls2.bnl.local:1025")
...
dbLoadRecords("db/asynComm.db","P=XF:16IDC-CT{MC:09},PORT=P0,ADDR=0")
dbLoadTemplate("db/motorstatus.substitutions")
dbLoadRecords("db/pmacStatus.db","SYS=XF:16IDC-CT,PMAC=MC:09,VERSION=1,PLC=5,PORT=P0,NAXES=8")
...
dbLoadRecords("db/iocAdminSoft.db","IOC=XF:16IDC-CT{IOC:MC09}")
...
dbl > "/cf-update/xf16idc-ioc1.mc9.dbl"
