...
pmacAsynIPConfigure("P0","xf16idc-mc11.nsls2.bnl.local:1025")
...
pmacCreateController("M0","P0",0,7,100,1000)
...
dbLoadRecords("db/asynComm.db","P=XF:16IDC-CT{MC:11},PORT=P0,ADDR=0")
dbLoadTemplate("db/motorstatus.substitutions")
dbLoadRecords("db/pmacStatus.db","SYS=XF:16IDC-CT,PMAC=MC:11,VERSION=1,PLC=5,PORT=P0,NAXES=8")
...
dbLoadRecords("db/iocAdminSoft.db","IOC=XF:16IDC-CT{IOC:MC11}")
...
#dbl > "/cf-update/xf66ida-ioc1.mc1.dbl"
