...
/* Generated from ../O.Common/misc.dbd */
...
int misc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/misc";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"misc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    misc_registerRecordDeviceDriver(*iocshPpdbbase);
}
