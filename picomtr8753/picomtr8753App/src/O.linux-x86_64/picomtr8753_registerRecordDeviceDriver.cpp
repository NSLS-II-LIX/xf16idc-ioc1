...
/* Generated from ../O.Common/picomtr8753.dbd */
...
static const char * const deviceSupportNames[95] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[95] = {
...
int picomtr8753_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/picomtr8753";
    ...
    registerDevices(pbase, 95, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"picomtr8753_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    picomtr8753_registerRecordDeviceDriver(*iocshPpdbbase);
}
