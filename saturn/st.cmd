#!/epics/src-x86/dxp/bin/linux-x86/dxpApp

< /epics/src-x86/dxp/iocBoot/iocSaturn/envPaths
...
epicsEnvSet("PREFIX", "XF:16IDC-ES{Det:Sat}")
...
< /epics/src/latest/dxp/iocBoot/save_restore.cmd
