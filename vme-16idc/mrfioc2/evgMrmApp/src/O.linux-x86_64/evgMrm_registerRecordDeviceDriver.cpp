...
/* Generated from ../O.Common/evgMrm.dbd */
...
int evgMrm_registerRecordDeviceDriver(DBBASE *pbase)
{
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"evgMrm_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    evgMrm_registerRecordDeviceDriver(*iocshPpdbbase);
}
