...
/* Generated from ../O.Common/mrf.dbd */
...
static const char * const deviceSupportNames[140] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[140] = {
...
int mrf_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    registerDevices(pbase, 140, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"mrf_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    mrf_registerRecordDeviceDriver(*iocshPpdbbase);
}
