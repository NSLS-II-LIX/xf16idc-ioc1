...
/* Generated from ../O.Common/snmp2.dbd */
...
epicsShareExtern dset *pvar_dset_devAiSnmpV1;
epicsShareExtern dset *pvar_dset_devAiSnmpV2c;
epicsShareExtern dset *pvar_dset_devAiSnmpV2c;
...
epicsShareExtern dset *pvar_dset_devAoSnmpV1;
epicsShareExtern dset *pvar_dset_devAoSnmpV2c;
epicsShareExtern dset *pvar_dset_devAoSnmpV2c;
...
epicsShareExtern dset *pvar_dset_devLiSnmpV1;
epicsShareExtern dset *pvar_dset_devLiSnmpV2c;
epicsShareExtern dset *pvar_dset_devLiSnmpV2c;
epicsShareExtern dset *pvar_dset_devLoSoft;
epicsShareExtern dset *pvar_dset_devLoSoftCallback;
epicsShareExtern dset *pvar_dset_devLoSnmpV1;
epicsShareExtern dset *pvar_dset_devLoSnmpV2c;
epicsShareExtern dset *pvar_dset_devLoSnmpV2c;
...
epicsShareExtern dset *pvar_dset_devMbbiDSnmpV1;
epicsShareExtern dset *pvar_dset_devMbbiDSnmpV2c;
epicsShareExtern dset *pvar_dset_devMbbiDSnmpV2c;
...
epicsShareExtern dset *pvar_dset_devSiSnmpV1;
epicsShareExtern dset *pvar_dset_devSiSnmpV2c;
epicsShareExtern dset *pvar_dset_devSiSnmpV2c;
...
epicsShareExtern dset *pvar_dset_devSoSnmpV1;
epicsShareExtern dset *pvar_dset_devSoSnmpV2c;
epicsShareExtern dset *pvar_dset_devSoSnmpV2c;
epicsShareExtern dset *pvar_dset_devSASoft;
epicsShareExtern dset *pvar_dset_devWfSoft;
epicsShareExtern dset *pvar_dset_devWfSnmpV1;
epicsShareExtern dset *pvar_dset_devWfSnmpV2c;
epicsShareExtern dset *pvar_dset_devWfSnmpV2c;

static const char * const deviceSupportNames[73] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[73] = {
    ...
    pvar_dset_devAiSnmpV1,
    pvar_dset_devAiSnmpV2c,
    pvar_dset_devAiSnmpV2c,
    ...
    pvar_dset_devAoSnmpV1,
    pvar_dset_devAoSnmpV2c,
    pvar_dset_devAoSnmpV2c,
    ...
    pvar_dset_devLiSnmpV1,
    pvar_dset_devLiSnmpV2c,
    pvar_dset_devLiSnmpV2c,
    pvar_dset_devLoSoft,
    pvar_dset_devLoSoftCallback,
    pvar_dset_devLoSnmpV1,
    pvar_dset_devLoSnmpV2c,
    pvar_dset_devLoSnmpV2c,
    pvar_dset_devMbbiSoft,
    pvar_dset_devMbbiSoftRaw,
    pvar_dset_devMbbiDirectSoft,
    pvar_dset_devMbbiDirectSoftRaw,
    pvar_dset_devMbbiDSnmpV1,
    pvar_dset_devMbbiDSnmpV2c,
    pvar_dset_devMbbiDSnmpV2c,
    ...
    pvar_dset_devSiSnmpV1,
    pvar_dset_devSiSnmpV2c,
    pvar_dset_devSiSnmpV2c,
    ...
    pvar_dset_devSoSnmpV1,
    pvar_dset_devSoSnmpV2c,
    pvar_dset_devSoSnmpV2c,
    pvar_dset_devSASoft,
    pvar_dset_devWfSoft,
    pvar_dset_devWfSnmpV1,
    pvar_dset_devWfSnmpV2c,
    pvar_dset_devWfSnmpV2c
};

epicsShareExtern drvet *pvar_drvet_drvSnmp;
...
int snmp2_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    registerDevices(pbase, 73, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"snmp2_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    snmp2_registerRecordDeviceDriver(*iocshPpdbbase);
}
