...
extern "C" {
  ...
  char Counter32[] = "Counter32";
    char Counter64[] = "Counter64";
    char Gauge32[]   = "Gauge32";
    char Gauge64[]   = "Gauge64";
    char Timeticks[] = "Timeticks";
    char HexSTRING[] = "Hex-STRING";
    char NetworkAddress[] = "Network Address";
  ...
  SNMP_TYPE_CONV wfTypes[] =
  {
     ...
     { HexSTRING,      snmpWfHexStrConvert,    (size_t) 0            },
     { NetworkAddress, snmpWfNetAddrConvert,   (size_t) 0            },
